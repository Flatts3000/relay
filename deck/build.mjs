...
:root{
  ...
  --amber:#d97706; --amber-50:#fffbeb; --amber-300:#fcd34d;
  --red:#dc2626;
...
.shot .bar{display:flex;align-items:center;gap:6px;padding:8px 11px;background:#f3f4f6;border-bottom:1px solid var(--line);height:auto}
...
.bar .wm{color:var(--ink-2);font-weight:500;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.bar .wm b{color:var(--primary-600)}
.bar .meta{white-space:nowrap}
.nav{display:flex;gap:6px}
.nav button{font-family:var(--mono);font-size:.8rem;color:var(--ink-2);background:var(--surface);
  border:1px solid var(--line);border-radius:var(--r-sm);width:44px;height:34px;cursor:pointer;transition:.15s}
...
<div class="chrome">
  ...
  <div class="bar">
    ...
    <span class="meta"><span class="sec"></span> &nbsp;&middot;&nbsp; <span class="counter"></span></span>
  </div>
</div>
<script>${JS}</script>
</body></html>`;
