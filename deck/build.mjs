...
const slides = [
  ...
  `<section class="slide" data-name="What Relay is">
    <div class="stack">
      ...
      <div class="cols two">
        <div class="ledger">
          <span class="yes">IS</span><span>A list of local groups anyone can search, with no account and nothing recorded about the search</span>
          ...
          <span class="no">NOT</span><span>A judge of who deserves help. Relay never makes that decision, and cannot</span>
