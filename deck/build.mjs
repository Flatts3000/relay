...
const slides = [
  ...
  `<section class="slide" data-name="Relay">
    <div class="stack">
      ...
      <p class="lede">Relay is that missing connection, built so that using it does not put anyone at risk. It never decides who deserves aid and never touches the money.</p>
    ...
    <div class="stack">
      ...
      <div class="cols three" style="margin-top:4px">
        <div class="card flag">
          ...
          <p>Three Atlanta Solidarity Fund organizers were arrested in May 2023 over what Nonprofit Quarterly describes as routine nonprofit reimbursements. The money laundering charges were dropped in September 2024; racketeering charges - brought under a law written to prosecute organized crime - remain outstanding against 61 defendants.</p>
        </div>
        <div class="card flag">
          <h3>The apps people use to send money keep records</h3>
          <p>Tax reporting rules on money-sharing apps put a permanent record behind ordinary transfers between neighbors, which is how most mutual aid moves money today.</p>
        </div>
        <div class="card flag">
          <h3>Organizers fear being changed by the money</h3>
          <p>Taking on foundation structure and its compliance rules is widely seen as blunting the work. Any tool arriving in this space is judged against that suspicion, and should be.</p>
        </div>
      </div>
