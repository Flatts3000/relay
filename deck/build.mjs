...
const slides = [
  ...
  `<section class="slide" data-name="Relay">
    <div class="stack">
      <div class="badge"><span class="pulse"></span> RELAYFUNDS.ORG &nbsp;&middot;&nbsp; BUILT AND DEPLOYED &middot; NOT YET PILOTED &middot; NOT FUNDRAISING</div>
  ...
  `<section class="slide" data-name="Next">
    <div class="stack">
      ...
      <div class="cols three" style="margin-top:6px">
        ...
        <div class="card accent"><h3>Anyone who knows one</h3><p>The single most useful thing right now is an introduction. This needs one hub and a handful of groups, not money.</p></div>
      </div>
      <div class="cols two" style="margin-top:8px;align-items:start">
        <div class="card accent">
        ...
        <div class="card">
          <h3>What it runs on in the meantime</h3>
          <p>A single small server and the time of the people building it. That is the whole cost base, and it is being carried directly rather than granted.</p>
          <p style="margin-top:10px">When that changes, the natural market is public-interest technology funding rather than human services - a threat model, a copyleft licence, a reviewed cryptographic design and a public tracker are what that market selects on. Not today's conversation.</p>
        </div>
      </div>
